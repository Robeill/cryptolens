...
RULES: tuple[Rule, ...] = tuple(
    ...
    + [
        ...
        Rule(
            match="cryptography.fernet.Fernet",
            algorithm="Fernet",
            ...
            key_size=128,
            classical_security_level=128,
            detector="pyca.fernet",
        ),
        Rule(
            match="cryptography.fernet.Fernet.generate_key",
            algorithm="Fernet",
            primitive=CryptoPrimitive.AE,
            purpose=CryptoPurpose.ENCRYPTION,
            ...
            key_size=128,
            classical_security_level=128,
            detector="pyca.fernet.keygen",
        ),
        Rule(
            match="cryptography.fernet.MultiFernet",
            algorithm="Fernet",
            primitive=CryptoPrimitive.AE,
            purpose=CryptoPurpose.ENCRYPTION,
            functions=(CryptoFunction.ENCRYPT, CryptoFunction.DECRYPT),
            ...
            key_size=128,
            classical_security_level=128,
            detector="pyca.fernet.multi",
        ),
        Rule(
            match=f"{PYCA_CIPHERS}.aead.AESGCM",
            algorithm="AES-GCM",
            primitive=CryptoPrimitive.AE,
            purpose=CryptoPurpose.ENCRYPTION,
            functions=(CryptoFunction.ENCRYPT, CryptoFunction.DECRYPT),
            mode=CryptoMode.GCM,
            detector="pyca.aead.aesgcm",
        ),
        Rule(
            match=f"{PYCA_CIPHERS}.aead.AESGCM.generate_key",
            algorithm="AES-GCM",
            primitive=CryptoPrimitive.AE,
            purpose=CryptoPurpose.ENCRYPTION,
            functions=(CryptoFunction.KEYGEN,),
            mode=CryptoMode.GCM,
            key_size_kwarg="bit_length",
            key_size_arg=0,
            detector="pyca.aead.aesgcm.keygen",
        ),
        Rule(
            match=f"{PYCA_CIPHERS}.aead.AESCCM",
            algorithm="AES-CCM",
            primitive=CryptoPrimitive.AE,
            purpose=CryptoPurpose.ENCRYPTION,
            functions=(CryptoFunction.ENCRYPT, CryptoFunction.DECRYPT),
            mode=CryptoMode.CCM,
            detector="pyca.aead.aesccm",
        ),
        Rule(
            match=f"{PYCA_CIPHERS}.aead.AESSIV",
            algorithm="AES-SIV",
            primitive=CryptoPrimitive.AE,
            purpose=CryptoPurpose.ENCRYPTION,
            functions=(CryptoFunction.ENCRYPT, CryptoFunction.DECRYPT),
            detector="pyca.aead.aessiv",
        ),
        Rule(
            match=f"{PYCA_CIPHERS}.aead.ChaCha20Poly1305",
            algorithm="ChaCha20-Poly1305",
            primitive=CryptoPrimitive.AE,
            purpose=CryptoPurpose.ENCRYPTION,
            functions=(CryptoFunction.ENCRYPT, CryptoFunction.DECRYPT),
            classical_security_level=256,
            detector="pyca.aead.chacha20poly1305",
        ),
        Rule(
            match=f"{PYCA_CIPHERS}.aead.ChaCha20Poly1305.generate_key",
            algorithm="ChaCha20-Poly1305",
            primitive=CryptoPrimitive.AE,
            purpose=CryptoPurpose.ENCRYPTION,
            functions=(CryptoFunction.KEYGEN,),
            classical_security_level=256,
            detector="pyca.aead.chacha20poly1305.keygen",
        ),
        Rule(
            match="cryptography.x509.load_pem_x509_certificate",
            algorithm="X.509",
            primitive=CryptoPrimitive.UNKNOWN,
            purpose=CryptoPurpose.UNKNOWN,
            asset_type=AssetType.CERTIFICATE,
            confidence=CONFIDENCE_OPAQUE_ARTIFACT,
            extra={"artifact": "x509_certificate"},
            detector="pyca.x509.load_pem",
        ),
        Rule(
            match="cryptography.x509.load_der_x509_certificate",
            algorithm="X.509",
            primitive=CryptoPrimitive.UNKNOWN,
            purpose=CryptoPurpose.UNKNOWN,
            asset_type=AssetType.CERTIFICATE,
